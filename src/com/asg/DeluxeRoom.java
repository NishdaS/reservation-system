...
public class DeluxeRoom extends Room {
	...
	private String bathtubDetails;

	//constructor
	public DeluxeRoom(String roomCategory, String roomType, String roomName, String roomDescription, double costPerDay, String spaceDetails,
			String bathtubDetails) throws AccommodationException {
		...
		this.bathtubDetails = bathtubDetails;
	}
	...
	public String getPersistentString() {
		return roomCategory + "," + roomType + "," + roomName + "," + roomDescription + "," +
				costPerDay + "," + roomNumber + "," + isCheckedIn + "," + numDays + "," + spaceDetails + "," + bathtubDetails;
	}
